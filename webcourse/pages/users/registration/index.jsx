    ...
    return (
        <Layout title="Вход" onlyUnAuth>
            <form className="d-flex flex-column mt-5" onSubmit={FormHandler}>
                ...
                <Input type="password" className="w-100 float-start form-control" placeholder="Повторите пароль"></Input>
                <div className="d-flex justify-content-center"><button type="submit" className="w-25 btn btn-success">Готово</button></div>
                <div className="d-flex justify-content-center"><ButtonLink href="/users/avtorization" className="row">Войти</ButtonLink></div>
            </form>
        </Layout>
    );
};
